...
def add_uvvm_basic(hr):
    hr.add_files(filename='../../uvvm/uvvm_util/src/*.vhd',
                      library_name='uvvm_util')
    hr.add_files(filename='../../uvvm/uvvm_vvc_framework/src/*.vhd',
                      library_name='uvvm_vvc_framework')
    hr.add_files(filename='../../uvvm/bitvis_vip_scoreboard/src/*.vhd',
...
def test_1(hr):
    ...
    # ========================================================================
    # Add DUT
    hr.add_files(filename='../../uvvm/bitvis_uart/src/*.vhd',
                library_name='bitvis_uart',
                code_coverage=True)

    hr.add_files(filename='../../uvvm/bitvis_irqc/src/*.vhd',
                 library_name='bitvis_irqc')

    # ========================================================================
    # Add verification IPs
    hr.add_files(filename='../../uvvm/bitvis_vip_sbi/src/*.vhd',
                 library_name='bitvis_vip_sbi')
    hr.add_files(filename='../../uvvm/uvvm_vvc_framework/src_target_dependent/*.vhd',
                 library_name='bitvis_vip_sbi')

    hr.add_files(filename='../../uvvm/bitvis_vip_uart/src/*.vhd',
                 library_name='bitvis_vip_uart')
    hr.add_files(filename='../../uvvm/uvvm_vvc_framework/src_target_dependent/*.vhd',
                 library_name='bitvis_vip_uart')

    hr.add_files(filename='../../uvvm/bitvis_vip_clock_generator/src/*.vhd',
    ...
    # ========================================================================
    # Add testbench
    hr.add_files(filename='../../uvvm/bitvis_uart/tb/*.vhd',
                 library_name='bitvis_uart')
    hr.add_files(filename='../../uvvm/bitvis_uart/tb/maintenance_tb/*.vhd',
                 library_name='bitvis_uart')
